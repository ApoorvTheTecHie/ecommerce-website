                ...
                <div> 
                    <Col md={12}>
                        <ul className="breadcrumb">
                            <li><a href="category.html#">Home</a>
                            </li>
                            <li>Ladies</li>
                        </ul>
                    </Col>    
                    ...
                    <Col md={9}>
                                                    ...
                                                    <div> 
                                                        <Col md={6} sm={6}>
                                                            <div className="products-number">
                                                                <strong>Show</strong>  <a href="category.html#" className="btn btn-default btn-sm btn-primary">12</a>  <a href="category.html#" className="btn btn-default btn-sm">24</a>  <a href="category.html#" className="btn btn-default btn-sm">All</a> products
                                                            </div>
                                                        </Col>    
                                                    </div>
                                                    <div>
                        ...
                        <div className="pages">
                            ...
                            <p className="loadMore">
                                <a href="category.html#" className="btn btn-primary btn-lg"><i className="fa fa-chevron-down"></i> Load more</a>
                            </p>

                            <ul className="pagination">
                                <li><a href="category.html#">&laquo;</a>
                                </li>
                                <li className="active"><a href="category.html#">1</a>
                                </li>
                                <li><a href="category.html#">2</a>
                                </li>
                                <li><a href="category.html#">3</a>
                                </li>
                                <li><a href="category.html#">4</a>
                                </li>
                                <li><a href="category.html#">5</a>
                                </li>
                                <li><a href="category.html#">&raquo;</a>
                                </li>
                            </ul>
                        </div>
