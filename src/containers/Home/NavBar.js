            ...
            <div className="navbar-collapse collapse" id="navigation">
                ...
                <ul className="nav navbar-nav navbar-left">
                    ...
                    <li className="dropdown yamm-fw">
                        <a href="index.html#" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Men <b className="caret"></b></a>
                    ...
                    <li className="dropdown yamm-fw">
                        <a href="index.html#" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Ladies <b className="caret"></b></a>
                        <ul className="dropdown-menu">
                            <li>
                                <div className="yamm-content">
                                    <div className="row">
                    ...
                    <li className="dropdown yamm-fw">
                        <a href="index.html#" className="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-delay="200">Template <b className="caret"></b></a>
                        <ul className="dropdown-menu">
                            <li>
                                <div className="yamm-content">
                                    <div className="row">
